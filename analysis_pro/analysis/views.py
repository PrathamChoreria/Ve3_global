...
def data_preprocessing(file_path, f):
    ...
    # Removing duplicates if there are any in the CSV file, except for 'Date' column
    df.drop_duplicates(subset=[col for col in df.columns if col != 'Date'], inplace=True)
